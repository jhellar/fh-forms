  ...
  return{
    "init": function (conn) {
      ...
      var fieldSchema = new Schema({
        ...
        "helpText": String,
        "type": {type: String, required: true, enum: ["text", "textarea", "number", "emailAddress", "dropdown", "radio", "checkbox", "location", "locationMap", "photo", "signature", "file", "dateTime", "sectionBreak", "matrix"]},
      ...
      var ruleConditionalStatementsSchema = new Schema({
        ...
        "restriction": {type: String, required: true, enum: ["is not","is equal to","is greater than","is less than","is on","is before","is after","is", "isNot", "contains", "doesNotContain", "beginsWith", "endsWith"]},
