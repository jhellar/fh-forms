  ...
  return{
    "init": function (conn) {
      ...
      var fieldSchema = new Schema({
        ...
        "helpText": String,
        "type": {type: String, required: true, enum: ["text", "textarea", "number", "emailAddress", "select", "radio", "checkbox", "locationLatLong", "locationNorthEast", "locationMap", "photo", "signature", "file", "date", "time", "dateTime", "sectionBreak"]},
        "repeating": {type: Boolean, default: false}, //All fields can be repeating.
        "fieldOptions": [{ any: Schema.Types.Mixed }],
      ...
      var formSubmissionSchema = new Schema({
        "submissionNumber": {"type": Number, default: 0, required: true},
        "appId": {type: String, required: true},
