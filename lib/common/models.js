...
module.exports = function (){
  ...
  return{
    "init": function (conn) {
      var schemaOptions = { strict: "throw",  versionKey: false  };
      ...
      var fieldSchema = new Schema({
        ...
        "helpText": String,
        "type": {type: String, required: true, enum: ["text", "textarea", "number", "emailAddress", "select", "radio", "checkbox", "location", "locationMap", "photo", "signature", "file", "dateTime", "sectionBreak", "matrix"]},
      ...
      var formSubmissionSchema = new Schema({
        "submissionCompletedTimestamp": {"type": Date},
        "appId": {type: String, required: true},
