  ...
  return{
    "init": function (conn) {
      ...
      var fieldSchema = new Schema({
        ...
        "helpText": String,
        "type": {type: String, required: true, enum: ["singleText", "multiText", "number", "emailAddress", "dropDownList", "radioButtons", "checkbox", "locationLatLong", "locationNorthEast", "locationMap", "photo", "signature", "file", "date", "time", "dateTime", "sectionBreak"]},
