  ...
  return{
    "init": function (conn) {
      ...
      var fieldRulesSchema = new Schema({ // All fields in a fieldRule are required
        ...
        "restriction": {type: String, required: true, enum: ["is equal to","is greater than","is less than","is on","is before","is after","is", "isNot", "contains", "doesNotContain", "beginsWith", "endsWith"]},
