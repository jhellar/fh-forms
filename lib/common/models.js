  ...
  return {
    "init": function (conn) {
      ...
      var fieldSchema = new Schema({
        ...
        "type": {type: String, required: true, enum: ["text", "textarea", "url", "number", "emailAddress", "dropdown", "radio", "checkboxes", "location", "locationMap", "photo", "signature", "file", "dateTime", "sectionBreak", "matrix", "barcode", "sliderNumber", "sliderOptions"]},
