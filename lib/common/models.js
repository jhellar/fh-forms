...
module.exports = function (){
  ...
  return {
    "init": function (conn, config) {
      ...
      var baseDataSourceCacheOptions = {
      ...
      var dataSourceCacheSchema = new Schema(baseDataSourceCacheOptions, schemaOptionsNoId);


      var auditLogEntryOptions = _.clone(baseDataSourceCacheOptions);
      _.extend(auditLogEntryOptions, {
        serviceGuid: {type: String, required: true},
        endpoint: {type: String, required: true}
      });
      var dataSourceAuditLogEntrySchema = new Schema(auditLogEntryOptions, schemaOptionsNoId);
      ...
      var dataSourceSchema = new Schema({
        ...
        auditLogs: [dataSourceAuditLogEntrySchema]
      }, schemaOptions);
