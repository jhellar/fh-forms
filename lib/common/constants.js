module.exports = {
  ...
  FORM_CONSTANTS: {
    ...
    DATE_TIME_FIELD_DEFAULT_FORMAT: "YYYY-MM-DD HH:mm:ss"
  },
  MODELNAMES: {
    FORM: "Form",
    PAGE: "Page",
  ...
  SUBMISSION_PDF_STRUCTURE_FILE: "submission.pdf.handlebars",
  SUBMISSION_PDF_CONTENT_FILE: "submission_template.handlebars",
  SUBMISSION_CSV_EXPORT: {
    COLLECTION_NAME: "submissioncsvexport",
    STATUS_ERROR: "error",
