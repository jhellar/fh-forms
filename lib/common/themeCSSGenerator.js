      ...
      },
      {
        ...
        "sub_sections": [
          ...
          },
          {
            ...
            "class_name": " td.active .number_container",
  ...
  function generateThemeCSS(){
    ...
    styleStructure.sections.forEach(function (themeSection) {
      ...
      subSections.forEach(function (subSection) {
        ...
        console.log("cssGenerated: ", cssGenerated);
        ...
        console.log("staticCSS: ", staticCSS);
        ...
        console.log("fullClassDefinition: ", fullClassDefinition);

        var additionalClassCSS = generateClassAdditions(cssClassName, subSection.classAdditions);

        console.log("additionalClassCSS: ", additionalClassCSS);
