...
var themeCSSGenerator = function(themeJSON){
  ...
  function processThemeJSON(){
    ...
    for(var cssClass in generatedCSSJSON[FH_APPFORM_PREFIX]){
      ...
      for(var classAdditionIndex = 0; classAdditionIndex < cssClassInfo.classNameAdditions.length; classAdditionIndex++){
        classNameAdditions += cssClassInfo.classNameAdditions[classAdditionIndex];
      }

      if(cssClassInfo.classNameAdditionsChildren){
        for(var classAdditionIndex = 0; classAdditionIndex < cssClassInfo.classNameAdditionsChildren.length; classAdditionIndex++){
          classNameAdditions += cssClassName + cssClassInfo.classNameAdditionsChildren[classAdditionIndex];
        }
      }
