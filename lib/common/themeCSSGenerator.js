  ...
  var fh_styleStructure = {
    "logo": {
      "staticCSS": [
        ...
        {"key" : "maxHeight", "value" : "150px"}, //set max height for logo
        {"key" : "maxWidth", "value" : "95%"} //max width for logo
      ]
    },
    "sections": [
      {
  ...
  function generateLogoCSS() {
    if (styleStructure.logo) { //Only intend to generate a logo if it exists in the theme structure.
      if (themeJSON.logo) {
        ...
        if(themeJSON.logo.staticCSS.height > styleStructure.logo.maxHeight){
            var imageHeight = themeJSON.logo.maxHeight;
          ...
          if(themeJSON.logo.staticCSS.width > styleStructure.logo.staticCSS.maxWidth){
              var imageWidth = themeJSON.logo.maxWidth;
