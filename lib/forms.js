...
// forms.getSubmissionFile({"uri": mongoUrl}, {"_id" : req.params.fileGroupId}, function(err, result){
  ...
  getAllGroups: function (options, cb) {
    ...
    self.initConnection(options, function(err, connections) {
      if(err) return cb(err);
      return require('./impl/groups.js').getAllGroups(connections, options, cb);
    });
  },
  ...
  getGroup: function (options, params, cb) {
    ...
    self.initConnection(options, function(err, connections) {
      if(err) return cb(err);
      return require('./impl/groups.js').getGroup(connections, options, params, cb);
    });
  },
  ...
  updateGroup: function (options, params, cb) {
    ...
    self.initConnection(options, function(err, connections) {
      if(err) return cb(err);
      return require('./impl/groups.js').updateGroup(connections, options, params, cb);
    });
  },

  createGroup: function (options, params, cb) {
    var self = this;
console.log('in createGroup() - self:', self);
    self.initConnection(options, function(err, connections) {
      if(err) return cb(err);
      return require('./impl/groups.js').createGroup(connections, options, params, cb);
    });
  },
  ...
  deleteGroup: function (options, params, cb) {
    ...
    self.initConnection(options, function(err, connections) {
      if(err) return cb(err);
      return require('./impl/groups.js').deleteGroup(connections, options, params, cb);
    });
  }
};
