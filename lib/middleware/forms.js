...
function search(req, res, next){
  ...
  forms.findForms(req.connectionOptions, projectForms, function(err, formsList){
    if(err){
      return next(err);
    }
    ...
    async.map(formsList, function(foundForm, cb){
      ...
      forms.getForm(_.extend(req.connectionOptions, getParams), cb);
...
function get(req, res, next){
  ...
  //Admin Fields Should Not Be Shown For App Requests
  var showAdminFields = !req.params.projectid;
