module.exports = function () {
  ...
  function getForms(connections, options, cb) {
    ...
    function constructResultJSON(cb){
      var res = {"forms": []};
      if(foundAppForms){
        console.log("found forms preparing response");
        ...
        async.eachSeries(foundAppForms, function(foundAppForm, cb){
          ...
          formEntry.createdBy = foundAppForm.createdBy;
          ...
          console.log("about to push formEntry");
