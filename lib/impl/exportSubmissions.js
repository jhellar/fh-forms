...
function buildCSVsForSingleForm(formSubmissionModel, params, formId, callback) {
  ...
  var formName;
  async.waterfall([
    function buildCompositeForm(cb) {
      var mergedFields = {};
      mergedFields[formId] = {};
      ...
      var mapReduceOptions = {
        map: function(){
          ...
          emit(this.formSubmittedAgainst.lastUpdated, this.formSubmittedAgainst);
        },
      ...
      formSubmissionModel.mapReduce(mapReduceOptions, function(err, subFormsSubmittedAgainst){
        ...
        return cb(undefined, mergedFields);
      });
    },
    function buildSubmissionCSVForSingleForm(mergedFields, cb) {
