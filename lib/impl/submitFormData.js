...
var submitFormData = function(connections, options, cb) {
  ...
  function lookupSubmission(cb){
    console.log("SUBMIT FORM DATA LOOK UP SUBMISSION" , "*********** ");
  ...
  function saveSubmission(cb){
    console.log("SUBMIT FORM DATA SAVE SUBMISSION" , "*********** ");
    ...
    formSubmission.save(function(err, updatedForm){
      console.log("FORM SUBMISSION SAVE CB ********** ", err, updatedForm);
  ...
  function validateSubmission(cb){
    console.log("validateSubmission skipping ", skipValidation);
    if(skipValidation){
      console.log("SUBMIT FORM DATA VALIDATE SUBMISSION SKIPPED" , "*********** ");
      cb();
    }
    else{
      console.log("SUBMIT FORM DATA VALIDATE SUBMISSION NOT!! SKIPPED" , "*********** ");
      async.series([validateSubmissionParams, validateSubmissionData], cb);
    }
  }

  function validateSubmissionParams(cb){
    console.log("SUBMIT FORM DATA VALIDATE SUBMISSION PARAMS" , "*********** ");
  ...
  function validateSubmissionData(cb){
    console.log("SUBMIT FORM DATA VALIDATE SUBMISSION DATA" , "*********** ");
  ...
  function checkFormForUpgrade(currentFormJSON, cb){
    console.log("SUBMIT FORM CHECK FORM FOR UPGRADE" , "*********** ");
  ...
  function validateDataAgainstCurrentForm(currentFormJSON, cb){
    ...
    if(skipValidation){
      console.log("SUBMIT FORM DATA VALIDATE validateDataAgainstCurrentForm SKIPPED" , "*********** ");
      return cb();
    }
    console.log("SUBMIT FORM DATA VALIDATE validateDataAgainstCurrentForm NOT SKIPPED" , "*********** ");
