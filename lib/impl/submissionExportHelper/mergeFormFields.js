...
/**
 * mergeFormFields - Merging the form field definitions between different definitons of the form.
 *
 ...
 *
 * @param  {object} mergedFields Current merged field defintions
 * @param  {object} formToMerge  Form JSON defintion
...
module.exports = function mergeFormFields(mergedFields, formToMerge) {
  ...
  _.each(formToMerge.pages || [], function (page) {
    _.each(page.fields || [], function (field) {
      ...
      if(!mergedFields[field._id] && CONSTANTS.FORM_CONSTANTS.FIELD_TYPE_MATRIX !== field.type &&
        CONSTANTS.FORM_CONSTANTS.FIELD_TYPE_SECTION_BREAK !== field.type) {
